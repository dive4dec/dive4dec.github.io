"use strict";
(self["webpackChunkjupyter_divewidgets"] = self["webpackChunkjupyter_divewidgets"] || []).push([["vendors-node_modules_codemirror_search_dist_index_js"],{
...
/* harmony export */ });
/* harmony import */ var _codemirror_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @codemirror/view */ "webpack/sharing/consume/default/@codemirror/view/@codemirror/view?dd66");
...
/* harmony import */ var _codemirror_state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @codemirror/state */ "webpack/sharing/consume/default/@codemirror/state/@codemirror/state?8fad");
...
const replaceNext = /*@__PURE__*/searchCommand((view, { query }) => {
    ...
    if (next.from == from && next.to == to) {
        ...
        announce.push(_codemirror_view__WEBPACK_IMPORTED_MODULE_0__.EditorView.announce.of(state.phrase("replaced match on line $", state.doc.lineAt(from).number) + "."));
    }
    if (next) {
...
//# sourceMappingURL=vendors-node_modules_codemirror_search_dist_index_js.040ea75d92569c1c3499.js.map