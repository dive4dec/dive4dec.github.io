...
/* harmony import */ var _codemirror_language__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @codemirror/language */ "webpack/sharing/consume/default/@codemirror/language/@codemirror/language?cdd8");
...
/* harmony import */ var _codemirror_state__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @codemirror/state */ "webpack/sharing/consume/default/@codemirror/state/@codemirror/state?8fad");
...
/* harmony import */ var _codemirror_view__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @codemirror/view */ "webpack/sharing/consume/default/@codemirror/view/@codemirror/view?dd66");
...
/* harmony import */ var _codemirror_autocomplete__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @codemirror/autocomplete */ "webpack/sharing/consume/default/@codemirror/autocomplete/@codemirror/autocomplete?894c");
/* harmony import */ var _codemirror_autocomplete__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_codemirror_autocomplete__WEBPACK_IMPORTED_MODULE_4__);
...
function javascript(config = {}) {
    ...
    return new _codemirror_language__WEBPACK_IMPORTED_MODULE_1__.LanguageSupport(lang, [
        javascriptLanguage.data.of({
            autocomplete: (0,_codemirror_autocomplete__WEBPACK_IMPORTED_MODULE_4__.ifNotIn)(dontComplete, (0,_codemirror_autocomplete__WEBPACK_IMPORTED_MODULE_4__.completeFromList)(snippets.concat(keywords)))
        }),
        javascriptLanguage.data.of({
...
`/` is typed.
*/
const autoCloseTags = /*@__PURE__*/_codemirror_view__WEBPACK_IMPORTED_MODULE_3__.EditorView.inputHandler.of((view, from, to, text) => {
    ...
    let changes = state.changeByRange(range => {
        ...
        if (text == ">" && around.name == "JSXFragmentTag") {
            return { range: _codemirror_state__WEBPACK_IMPORTED_MODULE_2__.EditorSelection.cursor(head + 1), changes: { from: head, insert: `><>` } };
        }
            ...
            if (((_b = (_a = around.parent) === null || _a === void 0 ? void 0 : _a.lastChild) === null || _b === void 0 ? void 0 : _b.name) != "JSXEndTag" && (name = elementName(state.doc, around.parent, head)))
                return { range: _codemirror_state__WEBPACK_IMPORTED_MODULE_2__.EditorSelection.cursor(head + 1), changes: { from: head, insert: `></${name}>` } };
        }
            ...
            if (empty.from == head - 1 && ((_c = base.lastChild) === null || _c === void 0 ? void 0 : _c.name) != "JSXEndTag" && (name = elementName(state.doc, base === null || base === void 0 ? void 0 : base.firstChild, head))) {
                let insert = `/${name}>`;
                return { range: _codemirror_state__WEBPACK_IMPORTED_MODULE_2__.EditorSelection.cursor(head + insert.length), changes: { from: head, insert } };
            }
        }
        return { range };
    });
...
//# sourceMappingURL=vendors-node_modules_codemirror_lang-javascript_dist_index_js.c9de3d848a7ff9f7301a.js.map