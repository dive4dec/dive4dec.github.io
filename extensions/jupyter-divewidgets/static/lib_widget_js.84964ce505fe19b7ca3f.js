...
class OPTWidgetView extends base_1.DOMWidgetView {
    ...
    */
    setHtml() {
        this.outputIFrame.src = `https://dive4dec.github.io/optlite/#mode=display&code=${encodeURIComponent(this.model.get('script'))}`;
    }
}
